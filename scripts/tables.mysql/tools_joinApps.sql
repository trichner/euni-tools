...
CREATE TABLE `joinApps` (
  ...
  `resubbed` tinyint(1) NOT NULL,
  `poDeferred` tinyint(1) NOT NULL,
  `spoDeferred` tinyint(1) NOT NULL,
  `warReentry` tinyint(1) NOT NULL,
  `AFK` tinyint(1) NOT NULL,
  `AFKtime` datetime NOT NULL,
...
-- Dump completed on 2015-07-25 20:21:30
