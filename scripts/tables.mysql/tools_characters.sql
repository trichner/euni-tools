...
CREATE TABLE `characters` (
  ...
  `primaryChar` tinyint(1) NOT NULL,
  `firstPull` datetime NOT NULL,
  `latestPull` datetime NOT NULL,
  `charSheetCache` datetime NOT NULL,
...
-- Dump completed on 2015-07-25 20:21:26
