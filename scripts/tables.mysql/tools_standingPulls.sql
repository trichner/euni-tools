...
--
-- Table structure for table `standingPulls`
--

DROP TABLE IF EXISTS `standingPulls`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `standingPulls` (
  `standingID` int(11) NOT NULL AUTO_INCREMENT,
  `pullID` int(11) NOT NULL,
  `characterID` int(11) NOT NULL,
  `standings` text NOT NULL,
  `pulledOn` datetime NOT NULL,
  `converted` tinyint(1) NOT NULL,
  PRIMARY KEY (`standingID`)
) ENGINE=MyISAM AUTO_INCREMENT=110775 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2015-07-25 20:21:28
